...
$strConfigOpenSSLDisableWarning_desc = __('Disable the default warning that is displayed if openssl is missing for cookie authentication');
$strConfigOpenSSLDisableWarning_name = __('OpenSSL warning');
